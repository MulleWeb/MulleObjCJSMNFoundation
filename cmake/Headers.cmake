...
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCJSMNFoundation-import.h")
   set( PUBLIC_HEADERS
      "src/_MulleObjCJSMNFoundation-import.h"
      ${PUBLIC_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCJSMNFoundation-include.h")
   set( PUBLIC_HEADERS
      "src/_MulleObjCJSMNFoundation-include.h"
      ${PUBLIC_HEADERS}
   )
endif()
...
# add ignored headers back in so that the generators pick them up
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCJSMNFoundation-import-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleObjCJSMNFoundation-import-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCJSMNFoundation-include-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleObjCJSMNFoundation-include-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
